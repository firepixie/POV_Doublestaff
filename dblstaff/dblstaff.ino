/*------------------------------------------------------------------------
  POV LED double staff sketch.  Uses the following Adafruit parts (X2 for two staffs):
  ...
  - 144 LED/m DotStar strip (#2328 or #2329) One Meter is enough for one staff, Two meters for two staffs
...
void setup() {
  ...
  attachInterrupt(1, IRinterrupt, CHANGE);
